...
const renderBoard = () => {
  ...
  boardElement.innerHTML = ""; //setting board initally blank
  board.forEach((row, rowindex) => {
    row.forEach((square, squareindex) => {
      //To make the sqaure and give t dark and whie properties
      ...
      if (square) {
        ...
        pieceElement.addEventListener("dragstart", (e) => {
          if (pieceElement.draggable) {
            draggedPiece = pieceElement; // Piece element is the pieces of the chess.
